	...
	<div class="col-md-12 col-md-offset-6">
		...
		<!-- Form for Login -->
			<form method="POST" class="log" action="controller/loginController.php">
				...
				<!-- Conta -->
				<input type="text" name="conta" class="form-control field" placeholder="Número da conta" required><br>
			...
			<!-- Copyright Fernando Rodrigues-->

			<p id="credits">&copy; Fernando Rodrigues - <?php echo date("Y"); ?> - Todos os direitos Reservados</p>
